 ...
 * @return array
 */
global $wpconnect_wpcf7_notion_custom_cf7_tags;
$wpconnect_wpcf7_notion_custom_cf7_tags = array();

function wpconnect_wpcf7_notion_track_custom_cf7_tags($tag) {
	global $wpconnect_wpcf7_notion_custom_cf7_tags;
	...
	if (is_array($tag) && isset($tag['type'])) {
		if (!in_array($tag['type'], $standard_cf7_types) && !in_array($tag['type'], $wpconnect_wpcf7_notion_custom_cf7_tags)) {
			$wpconnect_wpcf7_notion_custom_cf7_tags[] = $tag['type'];
		}
	}
...
add_filter( 'wpcf7_form_tag', 'wpconnect_wpcf7_notion_track_custom_cf7_tags', 10, 1);
